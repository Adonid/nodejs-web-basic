...
const {generalMiddleware, editorMiddleware} = require('../../../middleware')
 ...
 * 
 */
 router.post('/update', generalMiddleware.checkUpdatePost, editorMiddleware.checkIsMyPost, async (req, res) => {
